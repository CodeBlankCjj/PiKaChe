...
const player = {
  ...
  init: () => {
    player.ui.demo.innerText = _cssDefault.default.substr(0, player.n);
    player.ui.demo2.innerHTML = _cssDefault.default.substr(0, player.n);
    player.play();
    player.bindEvents();
  },
  bindEvents: () => {
...
},{"./css":"5HsDD","@parcel/transformer-js/lib/esmodule-helpers.js":"633Q8"}],"5HsDD":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
...
},{"@parcel/transformer-js/lib/esmodule-helpers.js":"633Q8"}],"633Q8":[function(require,module,exports) {
"use strict";
...
},{}]},["3AS1F","SXDIM"], "SXDIM", "parcelRequire427e")
